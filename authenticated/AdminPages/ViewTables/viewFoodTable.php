		...
		<td colspan="2" valign="top">
			...
			<?php
				...
				*/
				...
				setNextEditPage("/WebTechRepo/authenticated/AdminPages/EditTables/editFoodTable.php");
				setNextViewPage("/WebTechRepo/authenticated/AdminPages/ViewDetails/viewFoodDetails.php");
